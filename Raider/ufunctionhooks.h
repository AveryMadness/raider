    ...
    auto Initialize()
    {
        ...
        DEFINE_PEHOOK("Function FortniteGame.FortPlayerControllerZone.ClientOnPawnDied", {
            ...
            if (DeadPC->NetConnection)
            {
                ...
                if (((AFortPlayerStateAthena*)CurrentParams->DeathReport.KillerPlayerState) && CurrentParams->DeathReport.KillerPawn->Owner)
                    Spectate(DeadPC->NetConnection, ((AFortPlayerStateAthena*)CurrentParams->DeathReport.KillerPlayerState));
                std::cout << GameState->PlayersLeft << std::endl;
                if (GameState->PlayersLeft == 1)
                {
                    ...
                    if (!Controller->bClientNotifiedOfWin && Winner)
                    {
        ...
        DEFINE_PEHOOK("Function FortniteGame.FortPlayerController.ServerRepairBuildingActor", {
            ...
            DEFINE_PEHOOK("Function FortniteGame.FortKismetLibrary.K2_GiveBuildingResource", {
                 auto Params = (UFortKismetLibrary_K2_GiveBuildingResource_Params*)Parameters;
		        auto PC = (AFortPlayerControllerAthena*)Params->Controller;
                ...
                AddItem(PC, ResourceType, 0, EFortQuickBars::Secondary, Params->ResourceAmount);
